    ...
    def draw(self, screen, camera_x, camera_y):
        ...
        if self.category == "defense":
            if self.build_type in ("wooden_wall", "stone_wall", "crystal_wall"):
                ...
                pygame.draw.rect(screen, (max(0, draw_color[0] -
                                              30), max(0, draw_color[1] -
                                                       30), max(0, draw_color[2] -
                                                                30)), (sx -
                                                                       self.size //
                                                                       2, sy -
                                                                       self.size //
...
class BaseBuilder:
    ...
    def draw_build_menu(self, screen, player_resources):
        ...
        if ctrl:
            ...
            xbox_icons.draw_menu_prompt(screen, [("A", "Click", "Select"),
                                        ("X", "E", "Place"), ("B", "V", "Exit")], menu_y + menu_h - 25)
        else:
